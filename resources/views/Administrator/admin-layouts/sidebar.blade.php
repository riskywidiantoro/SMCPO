<nav class="pcoded-navbar" pcoded-header-position="relative">
    ...
    <div class="pcoded-inner-navbar main-menu">
        <div class="">
            <div class="main-menu-header">
                <div class="user-details">
                    <span>Rizkyanoor Widiantoro</span>
                    <span id="more-details"><small>Marketing Data Staff RO
                            Banjarmasin</small></span>
                </div>
            </div>
        </div>
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.extra-components.main">Coverage
                        Management
                    </span>
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="zmdi zmdi-store"></i></span>
                    <span class="pcoded-mtext" data-i18n="nav.extra-components.main">Outlet
                    </span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.extra-components.main">Consumer</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" ">
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.extra-components.main">Field
                        Marketing</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.extra-components.main">Salesperson</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" ">
        ...
        <div class="pcoded-navigatio-lavel" data-i18n="nav.category.ui-element" menu-title-theme="theme5">CPO</div>
        <div class="pcoded-navigatio-lavel" data-i18n="nav.category.ui-element" menu-title-theme="theme5">Report</div>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.extra-components.main">Master Default
                    </span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
